...
#[derive(Debug)]
pub struct MedusaStoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MedusaStoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MedusaStore processing");
    
    let mut processor = MedusaStoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MedusaStoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MedusaStoreProcessor::new(false);
